//
//  SellDetailTableViewController.h
...
@interface SellDetailTableViewController : UITableViewController
...
@property (weak, nonatomic) IBOutlet UITableViewCell *purchaserNameCell;
