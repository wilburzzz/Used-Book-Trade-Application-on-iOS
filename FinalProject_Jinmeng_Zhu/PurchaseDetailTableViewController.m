//
//  PurchaseDetailTableViewController.m
...
@interface PurchaseDetailTableViewController ()

@end

@implementation PurchaseDetailTableViewController
...
- (void)viewDidLoad
{
    ...
    self.sellerNameCell.textLabel.text = @"Seller";
    ...
    self.sellerNameCell.detailTextLabel.text = self.book.sellerName;
